<template>
  <div>
    ...
    <div class="messages">
      ...
      <div class="make_text">
        <p class="make_success">预约成功</p>
        <p class="k1">您的订单号为{{order_sn}}</p>
        <p class="k2">请留意您预约的手机号码，我们将您的预约信息发送到您的手机号上，您可于参观当日凭预约编码在二楼讲解台办理讲解服务祝您旅途愉快~</p>
      </div>
      <!-- 结尾付款 -->
      <div class="footer">
        <router-link class="cancle" to="/ureport" replace tag="div">查看订单</router-link>
        <router-link class="sure" to="/explain" replace tag="div">继续预约</router-link>
      </div>
    </div>
  </div>
</template>
